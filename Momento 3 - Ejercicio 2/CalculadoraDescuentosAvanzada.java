public class CalculadoraDescuentosAvanzada {
    ...
    public static double calcularPrecioFinal(double precioOriginal, String categoriaProducto, int cantidad, boolean esVIP) {
        double porcentajeCategoria = obtenerPorcentajeDescuentoCategoria(categoriaProducto);
        double precioTrasCategoria = precioOriginal * (1 - porcentajeCategoria);

        double porcentajeVolumen = obtenerPorcentajeDescuentoVolumen(cantidad);
        double precioTrasVolumen = precioTrasCategoria * (1 - porcentajeVolumen);

        double porcentajeVIP = obtenerPorcentajeDescuentoVIP(esVIP);
        double precioFinal = precioTrasVolumen * (1 - porcentajeVIP);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Precio Final Esperado: $" + String.format("%.2f", precioLaptop1 * 0.90));
        ...
        System.out.println("Precio Final Esperado: $" + String.format("%.2f", 50.00 * 0.80 * 0.95));
        ...
        System.out.println("Precio Final Esperado: $" + String.format("%.2f", 20.00 * 0.95 * 0.90 * 0.93));
        ...
        System.out.println("Precio Final Esperado: $" + String.format("%.2f", 30.00 * 0.93));
